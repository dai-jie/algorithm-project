...
public:
	...
	vector<vector<vector<double> > > blockSch; //The block schedule for each job: job number->count of cores->[finishtime 1, 2, 3...] 
	vector<vector<vector<double> > > blockTime; //The time consumed by each bolck; job number->count of cores->[bocktime1 2, 3...]
